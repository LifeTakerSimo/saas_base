...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 mt-80">
        <motion.div
        ...
        <div className="absolute inset-auto z-50 h-44 w-full -translate-y-[12.5rem] bg-slate-950 "></div>
      </div>

      <div className="relative z-50 flex flex-col items-center px-5 mt-40">
        {children}
      </div>
    </div>
  );
